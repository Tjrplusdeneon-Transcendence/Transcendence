...
function gameOverMessage() 
{
    ...
    if (isGameOverMessageShown) return;
    ...
    const secondaryText = winner === 'Player 1' ? 'Player 1 Wins' : winner + ' Wins';
...
function restartPong() 
{
    ...
    let startButton = document.getElementById('start-pong-game-btn');
    startButton.textContent = 'Start Game';
    startButton.removeEventListener('click', restartPong);

    startButton = document.getElementById('pong-matchmaking-btn');
    startButton.textContent = 'Matchmaking';
    startButton.removeEventListener('click', restartPong);

    document.getElementById('pong-matchmaking-btn').style.display = 'block';
    document.getElementById('start-pong-game-btn').style.display = 'block';
...
document.getElementById('pong-matchmaking-btn').addEventListener('click', function() {
    document.getElementById('pongCanvas').style.pointerEvents = 'auto';
    const selectedDifficulty = document.getElementById('difficultySelect').value;
    currentDifficulty = selectedDifficulty;
    document.getElementById('difficulty-menu').style.display = 'none';
    document.getElementById('pongCanvas').style.display = 'block';
    document.getElementById('start-pong-game-btn').style.display = 'none';

    const startButton = document.getElementById('pong-matchmaking-btn');
    startButton.textContent = 'Restart Game';
